...
<h2>タイトル記入欄</h2>
	...
	<ul>
		<li>
			タイトル：<%String title = (String)session.getAttribute("title");%>
...
<h2>問題内容記入欄</h2>
	...
	<br><br>
	<h2 style="width:20%; font-size:15pt; margin:0% 0% 5% 0%;"><%int No = (int)session.getAttribute("No");%>
...
<br><br>
<button>次へ</button>
<a href="/workbook/jsp/newworkbook3.jsp" class="button">終了</a>
</form>
</div>
</body>
</html>